...
@property (nonatomic, getter=useEmailAutoFiling, setter=setUseEmailAutoFiling:) BOOL useEmailAutoFiling;
...
@interface EDAMAccounting : NSObject <NSCoding> {
  ...
  int __businessRole;
  int32_t __unitDiscount;
  EDAMTimestamp __nextChargeDate;
...
@property (nonatomic, getter=unitDiscount, setter=setUnitDiscount:) int32_t unitDiscount;
@property (nonatomic, getter=nextChargeDate, setter=setNextChargeDate:) EDAMTimestamp nextChargeDate;
#endif
...
#if !__has_feature(objc_arc)
- (EDAMTimestamp) nextChargeDate;
- (void) setNextChargeDate: (EDAMTimestamp) nextChargeDate;
#endif
...
@property (nonatomic, getter=premiumUpgradable, setter=setPremiumUpgradable:) BOOL premiumUpgradable;
#endif
...
@property (nonatomic, retain, getter=businessUserInfo, setter=setBusinessUserInfo:) EDAMBusinessUserInfo * businessUserInfo;
#endif
...
@interface EDAMNoteAttributes : NSObject <NSCoding> {
  ...
  int64_t __reminderOrder;
  EDAMTimestamp __reminderDoneTime;
  EDAMTimestamp __reminderTime;
...
@property (nonatomic, getter=reminderOrder, setter=setReminderOrder:) int64_t reminderOrder;
@property (nonatomic, getter=reminderDoneTime, setter=setReminderDoneTime:) EDAMTimestamp reminderDoneTime;
@property (nonatomic, getter=reminderTime, setter=setReminderTime:) EDAMTimestamp reminderTime;
...
#if !__has_feature(objc_arc)
- (EDAMTimestamp) reminderDoneTime;
- (void) setReminderDoneTime: (EDAMTimestamp) reminderDoneTime;
#endif
- (BOOL) reminderDoneTimeIsSet;

#if !__has_feature(objc_arc)
- (EDAMTimestamp) reminderTime;
- (void) setReminderTime: (EDAMTimestamp) reminderTime;
#endif
...
#if TARGET_OS_IPHONE || (MAC_OS_X_VERSION_MAX_ALLOWED >= MAC_OS_X_VERSION_10_5)
@property (nonatomic, getter=includeAccount, setter=setIncludeAccount:) BOOL includeAccount;
@property (nonatomic, getter=includePersonalLinkedNotebooks, setter=setIncludePersonalLinkedNotebooks:) BOOL includePersonalLinkedNotebooks;
@property (nonatomic, getter=includeBusinessLinkedNotebooks, setter=setIncludeBusinessLinkedNotebooks:) BOOL includeBusinessLinkedNotebooks;
#endif
...
@property (nonatomic, getter=updateSequenceNum, setter=setUpdateSequenceNum:) int32_t updateSequenceNum;
@property (nonatomic, retain, getter=scope, setter=setScope:) EDAMSavedSearchScope * scope;
#endif
...
@property (nonatomic, retain, getter=sharedNotebooks, setter=setSharedNotebooks:) NSMutableArray * sharedNotebooks;
